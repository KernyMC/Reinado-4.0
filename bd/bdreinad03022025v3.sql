...
INSERT INTO `calificacion` VALUES (1,1,1,1,'Traje Típico',100,20.00),(2,1,1,2,'Traje Típico',100,20.00),(3,1,1,3,'Traje Típico',100,20.00),(4,1,1,4,'Traje Típico',100,8.00),(5,1,1,5,'Traje Típico',100,8.00),(6,1,1,6,'Traje Típico',100,6.00),(7,1,1,7,'Traje Típico',100,18.00),(8,1,1,8,'Traje Típico',100,6.00),(9,1,1,9,'Traje Típico',100,16.00),(10,1,1,10,'Traje Típico',100,16.00),(11,1,1,11,'Traje Típico',100,16.00),(12,1,1,12,'Traje Típico',100,16.00),(13,1,2,1,'Traje Típico',100,20.00),(14,1,2,2,'Traje Típico',100,20.00),(15,1,2,3,'Traje Típico',100,20.00),(16,1,2,4,'Traje Típico',100,14.00),(17,1,2,5,'Traje Típico',100,8.00),(18,1,2,6,'Traje Típico',100,4.00),(19,1,2,7,'Traje Típico',100,8.00),(20,1,2,8,'Traje Típico',100,10.00),(21,1,2,9,'Traje Típico',100,4.00),(22,1,2,10,'Traje Típico',100,8.00),(23,1,2,11,'Traje Típico',100,8.00),(24,1,2,12,'Traje Típico',100,6.00);
...
INSERT INTO `candidata` VALUES (1,8,1,'Morillo','Rodríguez','Wendy','Elizabeth',NULL,'Para mi la Universidad de las Fuerzas Armadas ESPE, signfica una gran oportunidad para desarrollarse profesionalmente, aprender a trabajar tanto de manera individual como grupal y poder adquirir nuevas habilidades y experiencias necesarias para desenvolverse en la carrera elegida. La ESPE nos brinda un gran apoyo, valores, conocimientos, disciplina, liderazgo y responsabilidades muy importantes al momentos de llegar a enfretar los desafíos que se nos presenten a lo largo de este trayecto.',NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL),(2,3,1,'Reyes','Pérez','Jessenia','del Rocío',NULL,'La Universidad de las Fuerzas Armadas ESPE es la llama encendida de la valentía y la disciplina, donde se forjan almas con la nobleza del saber en el crisol del honor, guiadas por el ideal del servir y engrandecer la patria.',NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL),(3,10,1,'Estrella','Paladines','Yariely','Nicole',NULL,'La ESPE simboliza para mí, el compromiso con la defensa y el progreso de nuestro país, guiándome en el camino de la responsabilidad y el liderazgo con integridad.',NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL),(4,9,1,'Morán','Vega','Andrea','Gisselle',NULL,'Para mi significa más que un lugar de aprendizaje, es un segundo hogar donde he crecido personal y academicamente. Aquí, he encontrado inspiración en los profesores, he formado lazos con mis compañeros y he descubierto mis pasiones y habilidades. Esta Universidad me ha enseñado el valor de la perseverancia, la colaboración y el pensamiento crítico, estoy orgullosa de ser parte de una comunidad que fomenta la excelencia y el desarrollo integral.',NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL),(5,4,1,'Fuertes','Ortega','Liz','Scarlet',NULL,'La universidad para mí es un viaje de descubrimiento y crecimiento, es donde encuentro mi pasión, hago amistades para toda la vida y aprendo más sobre mí misma. Es un lugar donde mis sueños toman forma y mi futuro comienza a construirse. ',NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL),(6,2,1,'Aguirre','Espinosa','Gabriela','Nicole',NULL,'Para mí, la gloriosa ESPE (Universidad de las Fuerzas Armadas) representa un período de crecimiento, formación y madurez en mi vida, donde he desarrollado habilidades y conocimientos valiosos que me han permitido crecer como persona. Es un lugar donde he encontrado apoyo, amistades y mentoría que me han ayudado a encontrar mi camino y a alcanzar mis objetivos.',NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL),(7,7,1,'Sancan','Portillo','Martha','Dayana',NULL,'La Universidad de las Fuerzas Armadas ESPE simboliza para mí el privilegio de aprender, servir, y desarrollarme con excelencia y disciplina, inspirándome a alcanzar grandes metas.',NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL),(8,1,1,'Díaz','Pozo','Rebeca','Anahí',NULL,'La universidad de las fuerzas Armadas para mi representa un conjunto de valores; es el compromiso con el que los profesores nos transmiten su conocimiento día a día, es el poder de representar a una comunidad de jóvenes que desean llegar a ser buenos profesionales en la vida, es la calidad de educación que transmiten a sus estudiantes con el objetivo de crear lideres de esta sociedad',NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL),(9,11,1,'Montalván','Maldonado','Ariana','Daniela',NULL,'Para mí la Universidad ESPE genera disciplina, lealtad, civismo y patriotismo crea personas con un espíritu de liderazgo, nos brinda la seguridad de expresarnos y ser mejores ciudadanos, forma a los estudiantes como grandes profesionales, con un pensamiento lleno de valores y madurez mental, la Universidad es un lugar donde no solo vas a crecer en conocimiento si no como persona aprenderás a trabajar en equipo y a desenvolverte en la sociedad, creas amistades inolvidables, en conclusión nuestra gran universidad forma grandes profesionales, y te deja grandes anécdotas, por algo somos una de las mejores universidades del Ecuador, categoría A.',NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL),(10,12,1,'Briones','Mosquera','Kimberly','Brisney',NULL,'ESPE, integración y empatía, personas amables que emprenden una dura batalla para lograr sus objetivos; más que un conjunto de maestros, estudiantes y entidades, es unión, compañerismo, aprendizaje colectivo que nos proyecta a un futuro más desarrollado y lleno del conocimiento que imparten nuestros queridos maestros. Me es un privilegio inmenso poder decir que esta Universidad, se ha ganado un espacio en mi corazon y cada pequeño aporte de quienes conformamos esta institución, sumará para la educación de futuras generaciones.',NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL),(11,6,1,'Acosta','Acosta','Rachel','Alexandra',NULL,'Para mí, La Universidad de las Fuerzas Armadas - ESPE es más que un lugar de aprendizaje; es un refugio donde mis sueños toman forma y mis habilidades se cultivan. Es aquí donde encuentro inspiración, apoyo y la oportunidad de crecer no solo intelectualmente, sino también como persona. Gracias a esta institución cada clase es una puerta hacia el conocimiento y cada profesor un guía en mi viaje hacia el éxito.',NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL),(12,5,1,'Arreaga','Riera','Estefani','Nicole',NULL,'La Universidad ESPE significa para mí un pilar fundamental en mi desarrollo académico, profesional y personal, donde he adquirido conocimientos valiosos para crecer como persona, enfrentando y superando desafíos, desarrollando independencia , madurez y forjado amistades duraderas.',NULL,NULL,NULL,NULL,NULL,NULL,0,0,NULL);
...
--
-- Table structure for table `desempates`
--

DROP TABLE IF EXISTS `desempates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `desempates` (
  `CANDIDATA_ID` int NOT NULL,
  `NOTA_DESEMPATE` int NOT NULL,
  PRIMARY KEY (`CANDIDATA_ID`),
  CONSTRAINT `desempates_ibfk_1` FOREIGN KEY (`CANDIDATA_ID`) REFERENCES `candidata` (`CANDIDATA_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `desempates`
--

LOCK TABLES `desempates` WRITE;
/*!40000 ALTER TABLE `desempates` DISABLE KEYS */;
/*!40000 ALTER TABLE `desempates` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `evento` VALUES (1,1,'Traje Típico',100,1,'si'),(2,1,'Traje Gala',100,1,'no'),(3,1,'Preguntas',100,1,'no'),(4,1,'Publico',100,1,'no');
...
-- Dump completed on 2025-02-03 20:12:26
